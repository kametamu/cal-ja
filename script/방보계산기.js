function cal() {
    ...
    var v1 = Number(document.getElementById("v1").value); // 防御
    var v2 = Number(document.getElementById("v2").value); // 保護
    var v3 = Number(document.getElementById("v3").value); // 被ダメージ
    var v4 = Number(document.getElementById("v4").value); // 受けたダメージ
    var v5 = $("#v5 option:selected").attr('value');  // ディフェンスランク別防御
    var v6 = $("#v5 option:selected").attr('value2');  // ディフェンスランク別防御
    var v7 = $("#v5 option:selected").attr('value3'); // ディフェンスランク別保護
    var v8 = $("#v5 option:selected").attr('value4'); // ディフェンスランク別保護
    var v9 = $("#v9 option:selected").attr('value'); // 盾の種類
    var v10 = Number(document.getElementById("v10").value); // 魔攻
    var v11 = Number(document.getElementById("v11").value); // 魔法シリンダー細工
    var v12 = $("#v12 option:selected").attr('value'); // 盾の種類

    var v13_1= $("#v13_1 option:selected").attr('value'); // ピアシング保護
    var v13_2= Number(document.getElementById("v13_2").value) // 保護減少
    var v14_1= $("#v13_1 option:selected").attr('value2'); // ピアシング保護
    var v14_2= Number(document.getElementById("v14_2").value) // 保護減少
    ...
    if (isNaN(res4m)) { // 値がなくて NaN が出る場合
